...
if (strcmp(nameVector->at(i).c_str(),"anywavehilbert") and strcmp(nameVector->at(i).c_str(),"anywave")){
      cout << "Try to create a default block for type: [" << nameVector->at(i) << "]" << endl;
      myDict->add_default_block(nameVector->at(i).c_str());
      cout << "... it seems ok" << endl;
...
//    string key();
//    string val();
//    defaultMap["f0Min"] = 50.0;
      //defaultMap["numPartials"] = string("10");
