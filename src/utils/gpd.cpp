...
void usage( void )
{
	...
	fprintf( stdout, "      -D <dictFILE.xml>              Read the dictionary from xml dictFILE.\n" );
	...
	fprintf( stdout, "     gpd -D /usr/local/mptk/reference/dictionary/dic_gabor_two_scales.xml -n 10 glockenspiel.wav bookTest.bin\n" );
  exit(0);
}
  ...
  struct option longopts[] =
      {
        ...
        {"nAtom",		required_argument, NULL, 'n'},
