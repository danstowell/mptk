...
#ifndef __anywave_block_plugin_h_
#define __anywave_block_plugin_h_
 ...
 */
class MP_Anywave_Block_Plugin_c:public MP_Block_c {
...
protected:
	...
	MP_Anywave_Block_Plugin_c( void );
	
	/** \brief Destructor
	 **/
	virtual ~MP_Anywave_Block_Plugin_c();
...
public:
	...
	MP_Support_t update_ip( const MP_Support_t *touch, GP_Pos_Book_c* book );
