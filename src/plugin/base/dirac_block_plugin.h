...
#ifndef __dirac_block_plugin_h_
#define __dirac_block_plugin_h_
...
class MP_Dirac_Block_Plugin_c:public MP_Block_c {
...
protected:
  ...
  virtual int init_parameter_map( void );
  ...
  MP_Dirac_Block_Plugin_c( void );

public:
  /* Destructor */
  ~MP_Dirac_Block_Plugin_c();
