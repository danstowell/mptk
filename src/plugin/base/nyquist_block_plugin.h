...
#ifndef __nyquist_block_plugin_h_
#define __nyquist_block_plugin_h_
...
class MP_Nyquist_Block_Plugin_c:public MP_Block_c {
...
/** \brief an initializer for the parameters which ARE NOT related to the signal in a parameter map
  ...
  MP_Nyquist_Block_Plugin_c( void );

public:
  /* Destructor */
  virtual ~MP_Nyquist_Block_Plugin_c();
