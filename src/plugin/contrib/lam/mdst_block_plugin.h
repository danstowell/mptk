...
#ifndef __mdst_block_plugin_h_
#define __mdst_block_plugin_h_
 ...
 *
 */
class MP_Mdst_Block_Plugin_c:public MP_Mclt_Abstract_Block_Plugin_c {
...
public:
   ...
   * \param paramMap the map containing the parameter to construct the block, for a generalized mdst block:
   */
...
protected:
  ...
  MP_Mdst_Block_Plugin_c( void );

public:

  /* Destructor */
  virtual ~MP_Mdst_Block_Plugin_c();
