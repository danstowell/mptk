...
/************************/
/* Local allocations    */
int MP_Mclt_Atom_Plugin_c::alloc_mclt_atom_param( const MP_Chan_t /* setNumChans */ )
{
...
/**************/
/* Destructor */
MP_Mclt_Atom_Plugin_c::~MP_Mclt_Atom_Plugin_c()
{
  if (phase) free( phase );
}
...
int MP_Mclt_Atom_Plugin_c::write( FILE *fid, const char mode )
{
...
/**********************/
/* Readable text dump */
int MP_Mclt_Atom_Plugin_c::info( FILE *fid )
{
...
/**********************/
/* Readable text dump */
int MP_Mclt_Atom_Plugin_c::info()
{

  unsigned int i = 0;
  int nChar = 0;

  nChar += (int)mp_info_msg( "Mclt ATOM", "%s window (window opt=%g)\n", window_name(windowType), windowOption );
...
/********************/
/* Waveform builder */
void MP_Mclt_Atom_Plugin_c::build_waveform( MP_Real_t *outBuffer )
{
...
int MP_Mclt_Atom_Plugin_c::add_to_tfmap( MP_TF_Map_c *tfmap, const char tfmapType )
{
...
/* Sorting function which characterizes various properties of the atom,
   along one channel */
int MP_Mclt_Atom_Plugin_c::has_field( int field ) {
...
{
  MP_Atom_Factory_c::register_new_atom_empty("mclt",&MP_Mclt_Atom_Plugin_c::mclt_atom_create_empty);
  MP_Atom_Factory_c::register_new_atom("mclt",&MP_Mclt_Atom_Plugin_c::create_fromxml,&MP_Mclt_Atom_Plugin_c::create_frombinary);
