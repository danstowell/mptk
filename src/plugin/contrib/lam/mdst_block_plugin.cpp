...
MP_Block_c* MP_Mdst_Block_Plugin_c::create( MP_Signal_c *setSignal, map<string, string, mp_ltstring> *paramMap )
{

  const char* func = "MP_Mclt_Block_Plugin_c::create( MP_Signal_c *setSignal, map<const char*, const char*, MP_Dict_c::ltstr> *paramMap )";
  MP_Mdst_Block_Plugin_c *newBlock = NULL;
  char*  convertEnd;
  ...
  newBlock = new MP_Mdst_Block_Plugin_c();
  if ( newBlock == NULL )
    {
  ...
  if (strcmp((*paramMap)["type"].c_str(),"mdst"))
    {
      mp_error_msg( func, "Parameter map does not define a MDST block.\n" );
      return( NULL );
    }
...
int MP_Mdst_Block_Plugin_c::init_parameters( const unsigned long int setFilterLen,
...
int MP_Mdst_Block_Plugin_c::init_parameter_map( const unsigned long int setFilterLen,
    const unsigned long int setFilterShift,
    const unsigned long int setFftSize,
    const unsigned char setWindowType,
    const double setWindowOption,
...
int MP_Mdst_Block_Plugin_c::plug_signal( MP_Signal_c *setSignal )
{
...
void MP_Mdst_Block_Plugin_c::nullify_signal( void )
{
...
/********************/
/* NULL constructor */
MP_Mdst_Block_Plugin_c::MP_Mdst_Block_Plugin_c( void )
...
/**************/
/* Destructor */
MP_Mdst_Block_Plugin_c::~MP_Mdst_Block_Plugin_c()
{
...
/********/
/* Type */
const char * MP_Mdst_Block_Plugin_c::type_name()
{
  return ("mdst");
}
...
/**********************/
/* Readable text dump */
int MP_Mdst_Block_Plugin_c::info( FILE *fid )
{
...
void MP_Mdst_Block_Plugin_c::update_frame(unsigned long int frameIdx,
                                   MP_Real_t *maxCorr,
    ...
    const unsigned long int freqIdx, MP_Dict_c* dict )
{
  ...
  MP_Mdst_Atom_Plugin_c *matom = NULL;
  ...
  /* Allocate the atom */
   *atom = NULL;
 MP_Atom_c* (*emptyAtomCreator)( MP_Dict_c* dict ) = MP_Atom_Factory_c::get_empty_atom_creator("mdst");
...
int MP_Mdst_Block_Plugin_c::alloc_energy( MP_Real_t **atomEnergy )
{
...
void MP_Mdst_Block_Plugin_c::get_parameters_type_map(map< string, string, mp_ltstring> * parameterMapType){

const char * func = "void MP_MDst_Block_Plugin_c::get_parameters_type_map()";
...
void MP_Mdst_Block_Plugin_c::get_parameters_info_map(map< string, string, mp_ltstring> * parameterMapInfo ){

const char * func = "void MP_Mdst_Block_Plugin_c::get_parameters_info_map()";
...
void MP_Mdst_Block_Plugin_c::get_parameters_default_map( map< string, string, mp_ltstring>* parameterMapDefault ){

const char * func = "void MP_Mdst_Block_Plugin_c::get_parameters_default_map()";

if ((*parameterMapDefault).empty()) {
(*parameterMapDefault)["type"] = "mdst";
...
{
  MP_Block_Factory_c::register_new_block("mdst",&MP_Mdst_Block_Plugin_c::create, &MP_Mdst_Block_Plugin_c::get_parameters_type_map, &MP_Mdst_Block_Plugin_c::get_parameters_info_map, &MP_Mdst_Block_Plugin_c::get_parameters_default_map );
}
