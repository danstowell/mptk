...
/*************/
/* Type name */
char * MP_Mdct_Atom_Plugin_c::type_name(void)
{
  return ("mdct");
}
...
{
  MP_Atom_Factory_c::get_atom_factory()->register_new_atom_empty("MdctAtom",&MP_Mdct_Atom_Plugin_c::mdct_atom_create_empty);
