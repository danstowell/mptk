...
int main( void ) 
{
	...
	for ( i = 0; i < MASK_SIZE; i++ ) 
		fprintf( stdout, "%1d", mask1.sieve[i] );
	fprintf( stdout, "\n" );

	fprintf( stdout, "MASK2 " );
	for ( i = 0; i < MASK_SIZE; i++ ) 
		fprintf( stdout, "%1d", mask2.sieve[i] );
	fprintf( stdout, "\n" );

	fprintf( stdout, "MASK3 " );
	for ( i = 0; i < MASK_SIZE; i++ ) 
		fprintf( stdout, "%1d", mask3.sieve[i] );
	fprintf( stdout, "\n" );


	if (mask1 == mask2) 
		fprintf( stdout, "MASK1 == MASK2 is TRUE.\n" );
	else                
		fprintf( stdout, "MASK1 == MASK2 is FALSE.\n" );
	...
	for ( i = 0; i < mask4.numAtoms; i++ ) 
		fprintf( stdout, "%1d", mask4.sieve[i] );
	fprintf( stdout, "\n" );
	...
	if (mask3 == mask5) 
		fprintf( stdout, "MASK3 == MASK5 is TRUE.\n" );
	else                
		fprintf( stdout, "MASK3 == MASK5 is FALSE.\n" );

	fprintf( stdout, "MASK3: " );
	for ( i = 0; i < mask3.numAtoms; i++ ) 
		fprintf( stdout, "%1d", mask3.sieve[i] );
	fprintf( stdout, "\n" );

	fprintf( stdout, "MASK5: " );
	for ( i = 0; i < mask5.numAtoms; i++ ) 
		fprintf( stdout, "%1d", mask5.sieve[i] );
	fprintf( stdout, "\n" );
