...
class MP_DCT_Interface_c
{
	...
	public:
		 ...
		 * \f[
		 * \mbox{out}[k] = \frac{1}{\sqrt(\mbox{dctSize})}\sum_{n=0}^{\mbox{dctSize}-1}\ mbox{in}[n] \cdot \cos\left(\frac{\pi}{\mbox{dctSize}}\left(n+\frac{1}{2}\right)\left(k+\frac{1}{2}\right)\right)
		 * \f]
		 * for \f$0 \leq k < \mbox{dctSize}\f$
...
class MP_DCTW_Interface_c:public MP_DCT_Interface_c
{
	...
	public:
		 ...
		 * The output buffers are filled with the values
		 * \f[
		 * \mbox{out}[k] = \sum_{n=0}^{\mbox{dctSize}-1}\ mbox{in}[n] \cdot \cos\left(\frac{\pi}{\mbox{dctSize}}\left(n+\frac{1}{2}\right)\left(k+\frac{1}{2}\right)\right)
		 * \f]
		 * for \f$0 \leq k < \mbox{dctSize}\f$
		 * where the signal is zero padded beyond the window size if necessary.
		 */
