...
public:
   ...
   *
   * \param pFile A stream, pointing to the file describing the
   * anywave table
   */
  MP_Anywave_Table_c( FILE* pFile );
 ...
 private:
   ...
   *
   * A MP_Anywave_Table_Scan_Info_c object is used to perform the parsing and
   * fill the members of the table.
   *
   * \return true for success, false for failure
   */
  bool parse_file( FILE* pFile );
