...
/*****************************************************/
/*                                                   */
/* DEFINITION OF THE anywave hilbert ATOM CLASS      */
/*                                                   */
/*****************************************************/
/*
 * CVS log:
...
#ifndef __anywave_hilbert_atom_h_
#define __anywave_hilbert_atom_h_
 ...
 **/
class MP_Anywave_Hilbert_Atom_c: public MP_Anywave_Atom_c {
 ...
 public:
   ...
   *
   **/
  MP_Anywave_Hilbert_Atom_c( void );

  /** \brief Specific constructor
   *
   * allocates the phase array, with the right number of channels
   * (setNumChans), sets atomType and hilbertTableIdx to zero, and
   * anywaveHilbertTable to NULL
   * 
