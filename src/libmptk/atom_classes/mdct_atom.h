...
#ifndef __mdct_atom_h_
#define __mdct_atom_h_
...
public:
   ...
   * \sa make_window()
   */
  static MP_Mdct_Atom_c* init( const MP_Chan_t setNumChans,
   ...
   * \sa read_atom()
   */
  static MP_Mdct_Atom_c* init( FILE *fid, const char mode );
