...
int MP_Mclt_Abstract_Block_c::init_parameters( const unsigned long int setFilterLen,
...
int MP_Mclt_Abstract_Block_c::plug_signal( MP_Signal_c *setSignal ) {
...
void MP_Mclt_Abstract_Block_c::nullify_signal( void ) {
...
/********************/
/* NULL constructor */
MP_Mclt_Abstract_Block_c::MP_Mclt_Abstract_Block_c( void )
  :MP_Block_c() {
...
/**************/
/* Destructor */
MP_Mclt_Abstract_Block_c::~MP_Mclt_Abstract_Block_c() {
...
int MP_Mclt_Abstract_Block_c::check_fftsize( const unsigned long int setFilterLen,
			       const unsigned long int setFftSize ) {
...
void MP_Mclt_Abstract_Block_c::init_transform( ) {
...
void MP_Mclt_Abstract_Block_c::compute_transform( MP_Real_t *in ) {
