...
#ifndef __mdct_block_h_
#define __mdct_block_h_
...
class MP_Mdct_Block_c:public MP_Mclt_Abstract_Block_c {
  ...
  /***************************/
public:
  /** \brief Factory function for a strict mdct block
   *
   ...
   */
  static MP_Mdct_Block_c* init( MP_Signal_c *s,
...
protected:
  ...
  MP_Mdct_Block_c( void );

public:

  /* Destructor */
  virtual ~MP_Mdct_Block_c();
