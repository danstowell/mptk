...
/*****************************************************/
/*                                                   */
/* DEFINITION OF THE anywave BLOCK CLASS            */
...
#ifndef __anywave_block_h_
#define __anywave_block_h_
...
/** \brief a MP_Anywave_Block_c is a block corresponding to anywave atoms. 
 *
 ...
 */
class MP_Anywave_Block_c:public MP_Block_c {
...
public:
   ...
   *
   */
  MP_Convolution_Fastest_c* convolution;
...
protected:
  ...
  MP_Anywave_Block_c( void );

  /** \brief Destructor
   **/
  virtual ~MP_Anywave_Block_c();
...
/** \brief Add a anywave block to a dictionary
 *
...
/** \brief Add a family of anywave blocks to a dictionary.
 *
