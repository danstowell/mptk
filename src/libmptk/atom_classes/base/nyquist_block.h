...
/**************************************************/
/*                                                */
/* DEFINITION OF THE NYQUIST BLOCK CLASS         */
/*                                                */
/**************************************************/
/*
 * SVN log:
...
#ifndef __nyquist_block_h_
#define __nyquist_block_h_
...
/**
 * \brief Nyquists are rectangular windows, of unit norm
 *
 * They are used to create (multichannel) nyquist atoms */

class MP_Nyquist_Block_c:public MP_Block_c {
...
public:
  ...
  /** \brief Factory function of a nyquist block 
   * \param s the signal on which the block will work */
  static MP_Nyquist_Block_c* init( MP_Signal_c *s,
...
protected:
  ...
  MP_Nyquist_Block_c( void );

public:
  /* Destructor */
  virtual ~MP_Nyquist_Block_c();
...
public:
   ...
   *
   * \todo Describe computation of inner products in the Nyquist case.
   *
