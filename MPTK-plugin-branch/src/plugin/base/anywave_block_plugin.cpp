...
int MP_Anywave_Block_Plugin_c::init_parameter_map( const unsigned long int setFilterShift,
    char* anywaveTableFilename,
    const unsigned long int setBlockOffset )
{
    ...
    const unsigned long int filterIdx )
{
  ...
  /* Allocate the atom */
  *atom = NULL;
  MP_Atom_c* (*emptyAtomCreator)( void ) = MP_Atom_Factory_c::get_atom_factory()->get_empty_atom_creator("AnywaveAtom");
