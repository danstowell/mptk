...
%--------------------------------------------------------------
\newcommand{\relativePath}{../GettingStarted/Images/}
...
\title{The Matching Pursuit Tool Kit \\ User Manual}
...
\input{../GettingStarted/GettingStartedContent}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 15cm, height=9cm]{mpcycle.eps}
...
%--------------------------------------------------------------
%--------------------------------------------------------------
% Section 2 : Download & install from sources
%--------------------------------------------------------------
%--------------------------------------------------------------
\chapter{Download \& install from source}

%--------------------------------------------------------------
% Section 2.1 : Installation under Windows
%--------------------------------------------------------------
\section{Installation under Windows}

% Section 2.1.1 : Required tools
...
\begin{my_itemize}
	...
	\begin{my_itemize}
		...
		\item Microsoft Visual Studio (tested with Visual C++ 2008 Express)
	\end{my_itemize}
	\item \underline{Optional (if Matlab is needed) :}
	\begin{my_itemize}
		\item Matlab at least version R2006 (\textbf{Caution} install Matlab in the default directory) :
		\begin{my_itemize}
...
% Section 2.1.2 : Required packages

\subsection{Required packages}
\begin{my_itemize}
	\item MPTK source archives : ``MPTK-Source-v.v.v.tar.gz'' (last version is 0.6.0)
	\item MPTK packaging utilities : NSIS Nullsoft packager (tested with version 2.46)
\end{my_itemize}

% Section 2.1.3 : Pre-configuration using cmake
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 7cm, height=4cm]{WindowsCmake.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 7cm, height=4cm]{VisualStudioCmake.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 7cm, height=4cm]{WindowsCmake2.eps}
	\textit{\caption{\label{WindowsCmake2} Cmake build system view for MPTK}}
\end{figure}

% Section 2.1.4 : Basic build
...
% Section 2.1.5 : Basic installation
...
%--------------------------------------------------------------
% Section 2.2 : Installation under Unix & MacOS
%--------------------------------------------------------------
\section{Installation under Unix \& MacOS}
...
% Section 2.2.2 : Required packages
...
\begin{my_itemize}
	...
	\item MPTK packaging utilities
	\begin{my_itemize}
		\item For Linux : RPM or DEB packaging tools (depending on Linux system)
		\item For Mac : PackageMaker packaging tool
	\end{my_itemize}
\end{my_itemize}
...
\begin{tt}
	...
	-- Configuring done \newline
	-- Generating done \newline
	-- Build files have been written to: \verb+~+/bar
\end{tt}

% Section 2.2.4 : Basic build

\subsection{Basic build}
The command {\tt make} will compile the build files

% Section 2.2.5 : Basic installation

\subsection{Basic installation}
The command {\tt sudo make install} will install in default directory /usr/local

% Section 2.2.6 : Setting build and install options

\subsection{Setting build and install options}
...
%--------------------------------------------------------------
% Section 2.3 : Installation Troubleshooting
%--------------------------------------------------------------
\section{Installation Troubleshooting \label{install_trouble}}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 7cm, height=4cm]{FailedCmake.eps}
...
% Section 2.3.1 : Advanced options
...
\begin{my_itemize}
	...
	\item BUILD\_EXECUTABLE: Build the executables (mpd, mpd\_demix, mpf, mpview, mpr, mpcat) in a bin directory (default value: ON)
\end{my_itemize}
...
%--------------------------------------------------------------
%--------------------------------------------------------------
\chapter{How to use MPTK command lines}
...
\underline{\textcolor{blue}{http://www.mega-nerd.com/libsndfile/}}) should work with 
the provided MPTK utilities.
...
%--------------------------------------------------------------
%--------------------------------------------------------------
\chapter{List of command lines functions}
...
%--------------------------------------------------------------
%--------------------------------------------------------------
\chapter{How to use MPTK with Matlab \label{use_matlab}}

%--------------------------------------------------------------
% Section 5.1 : Beginning with Matlab MEX commands
%--------------------------------------------------------------
\section{Beginning with Matlab MEX commands}

\noindent \underline{Unix \& MacOS:} matlabMexPath = /usr/local/mptk/matlab

\vspace{0,2 cm}

\noindent \underline{Windows:} : matlabMexPath =  C:\textbackslash Program Files\textbackslash 
MPTK\textbackslash mptk\textbackslash matlab

\vspace{0,3 cm}
	
If Matlab is installed under your computer, follow these instructions in order to make Matlab MEX files work.

\begin{my_enumerate}
	\item Launch Mathworks Matlab
	\item Select the current folder as ``matlabMexPath'' mentioned above. You should see the MexFiles related to your computer : 
		\begin{center}
			\begin{tabular}{lll}
			...
			\end{tabular}
		\end{center}
	\item Run GettingStarted in order to test MPTK
\end{my_enumerate}
...
structures rather close to the different ``blocks'' in the MP\_dictionnary definition.

\vspace{0.2 cm}

\underline{The `book' structure contains the following fields:}
\begin{my_itemize}
	...
	\item maxNumAtoms : Number of atoms that could fit in the storage space
...
%--------------------------------------------------------------
%--------------------------------------------------------------
\chapter{List of Matlab functions}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 12cm, height=7cm]{bookeditPage.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 10cm, height=3cm]{bookeditToolbar.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 5cm, height=3cm]{bookeditFileToolbar.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 5cm, height=3cm]{bookeditEditToolbar.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 5cm, height=3cm]{bookeditTransformToolbar.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 8cm, height=5cm]{cTestReport.eps}
...
%--------------------------------------------------------------
% Section 8.2 : Fixing FFTW used plan with wisdom in FFTW configuration
%--------------------------------------------------------------
\section{Fixing FFTW used plan with wisdom in FFTW configuration}
