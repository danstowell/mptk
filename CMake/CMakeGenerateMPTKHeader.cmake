...
FIND_FILE(MPTK_CONFIG_H config.h PATH ${MPTK_BINARY_DIR}/src/libmptk NO_DEFAULT_PATH)
IF(MPTK_CONFIG_H)
	SET(HAVE_MPTK_CONFIG_H 1 CACHE INTERNAL "Have include ${MPTK_SOURCE_DIR}/src/libmptk/config.h")
ENDIF(MPTK_CONFIG_H)

FIND_FILE(MPTK_MP_SYSTEM_H mp_system.h ${MPTK_SOURCE_DIR}/src/libmptk NO_DEFAULT_PATH)
IF(MPTK_MP_SYSTEM_H)
	SET(HAVE_MPTK_MP_SYSTEM_H 1 CACHE INTERNAL "Have include ${MPTK_SOURCE_DIR}/src/libmptk/mp_system.h")
ENDIF(MPTK_MP_SYSTEM_H)

FIND_FILE(MPTK_REGRESSION_CONSTANT_H regression_constants.h ${MPTK_SOURCE_DIR}/src/libmptk NO_DEFAULT_PATH)
