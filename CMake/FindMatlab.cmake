...
IF(PIPOL_IMAGE)
	IF(WIN32)
		IF(CMAKE_CL_64)
			SET(MATLAB_MEX_COMPILER "/netshare/amd64/matlab-2010a-windows/bin/mex.bat")
			SET(MATLAB_MEX_LIBRARY "/netshare/amd64/matlab-2010a-windows/extern/lib/win64/microsoft/libmex.lib")
			SET(MATLAB_MX_LIBRARY "/netshare/amd64/matlab-2010a-windows/extern/lib/win64/microsoft/libmx.lib")
			SET(MATLAB_ENG_LIBRARY "/netshare/amd64/matlab-2010a-windows/extern/lib/win64/microsoft/libeng.lib")
			SET(MATLAB_INCLUDE_DIR "/netshare/amd64/matlab-2010a-windows/extern/include")
			SET(MEX_EXTENSION mexw64)
		ELSE(CMAKE_CL_64)
			SET(MATLAB_MEX_COMPILER "/netshare/i386/matlab-2010a-windows/bin/mex.bat")
			SET(MATLAB_MEX_LIBRARY "/netshare/i386/matlab-2010a-windows/extern/lib/win32/microsoft/libmex.lib")
			SET(MATLAB_MX_LIBRARY "/netshare/i386/matlab-2010a-windows/extern/lib/win32/microsoft/libmx.lib")
			SET(MATLAB_ENG_LIBRARY "/netshare/i386/matlab-2010a-windows/extern/lib/win32/microsoft/libeng.lib")
			SET(MATLAB_INCLUDE_DIR "/netshare/i386/matlab-2010a-windows/extern/include")
