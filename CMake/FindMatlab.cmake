...
IF(PIPOL_IMAGE)
	IF(WIN32)
		IF(CMAKE_CL_64)
			SET(MATLAB_MEX_COMPILER "/cygdrive/y/i386/matlab-2010a-windows/bin/mex.bat")
			SET(MATLAB_MEX_LIBRARY "/cygdrive/y/i386/matlab-2010a-windows/extern/lib/win32/libmex.lib")
			SET(MATLAB_MX_LIBRARY "/cygdrive/y/i386/matlab-2010a-windows/extern/lib/win32/libmx.lib")
			SET(MATLAB_ENG_LIBRARY "/cygdrive/y/i386/matlab-2010a-windows/extern/lib/win32/libeng.lib")
			SET(MATLAB_INCLUDE_DIR "/cygdrive/y/i386/matlab-2010a-windows/extern/include")
	...
	IF(UNIX)
		...
		ELSE(APPLE)
			IF(CMAKE_SIZEOF_VOID_P MATCHES "4")
				...
				SET(MATLAB_MEX_LIBRARY "/netshare/i386/matlab-2010a-linux/extern/lib/win32/libmex.so")
				SET(MATLAB_MX_LIBRARY "/netshare/i386/matlab-2010a-linux/extern/lib/win32/libmx.so")
				SET(MATLAB_ENG_LIBRARY "/netshare/i386/matlab-2010a-linux/extern/lib/win32/libeng.so")
			...
			ELSE(CMAKE_SIZEOF_VOID_P MATCHES "4")
				...
				SET(MATLAB_MEX_LIBRARY "/netshare/amd64/matlab-2010a-linux/extern/lib/win32/libmex.so")
				SET(MATLAB_MX_LIBRARY "/netshare/amd64/matlab-2010a-linux/extern/lib/win32/libmx.so")
				SET(MATLAB_ENG_LIBRARY "/netshare/amd64/matlab-2010a-linux/extern/lib/win32/libeng.so")
