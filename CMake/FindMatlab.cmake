...
IF(UNIX)
	IF(APPLE)
		IF(PIPOL_IMAGE)
			MESSAGE("<<<<<<<<<< TROUVE PIPOL >>>>>>>>>>>>")
			FILE(GLOB MATLAB_PATHS "/netshare/none/matlab-*")
			MESSAGE("<<<<<<<<<< TROUVE PIPOL : ${MATLAB_PATHS} >>>>>>>>>>>>")
		ELSE(PIPOL_IMAGE)
			MESSAGE("<<<<<<<<<< TROUVE PAS PIPOL >>>>>>>>>>>>")
			FILE(GLOB MATLAB_PATHS "/Applications/MATLAB_*")
			MESSAGE("<<<<<<<<<< TROUVE PAS PIPOL : ${MATLAB_PATHS} >>>>>>>>>>>>")
		ENDIF(PIPOL_IMAGE)
