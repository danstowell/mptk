...
IF(PIPOL_IMAGE)
	IF(WIN32)
		IF($PIPOL_IMAGE MATCHES "[a][m][d][6][4]")
		MESSAGE("<<<<<<<<<<<<<<<<<< ON PASSE BIEN ICI >>>>>>>>>>>>>>>>")
		...
		ELSE($PIPOL_IMAGE MATCHES "[a][m][d][6][4]")
		MESSAGE("<<<<<<<<<<<<<<<<<< BAHABHABAHBAHBAH >>>>>>>>>>>>>>>>")
		...
		ENDIF($PIPOL_IMAGE MATCHES "[a][m][d][6][4]")
	ENDIF(WIN32)
	IF(UNIX)
		IF(APPLE)
