...
IF(PIPOL_IMAGE)
	IF(WIN32)
		IF(CMAKE_CL_64)
			SET(MATLAB_MEX_COMPILER "Y:/netshare/amd64/matlab-2010a-windows/bin/mex.bat")
			SET(MATLAB_MEX_LIBRARY "Y:/netshare/amd64/matlab-2010a-windows/extern/lib/win64/microsoft/libmex.lib")
			SET(MATLAB_MX_LIBRARY "Y:/netshare/amd64/matlab-2010a-windows/extern/lib/win64/microsoft/libmx.lib")
			SET(MATLAB_ENG_LIBRARY "Y:/netshare/amd64/matlab-2010a-windows/extern/lib/win64/microsoft/libeng.lib")
			SET(MATLAB_INCLUDE_DIR "Y:/netshare/amd64/matlab-2010a-windows/extern/include")
			SET(MEX_EXTENSION mexw64)
		ELSE(CMAKE_CL_64)
			SET(MATLAB_MEX_COMPILER "Y:/netshare/i386/matlab-2010a-windows/bin/mex.bat")
			SET(MATLAB_MEX_LIBRARY "Y:/netshare/i386/matlab-2010a-windows/extern/lib/win32/microsoft/libmex.lib")
			SET(MATLAB_MX_LIBRARY "Y:/netshare/i386/matlab-2010a-windows/extern/lib/win32/microsoft/libmx.lib")
			SET(MATLAB_ENG_LIBRARY "Y:/netshare/i386/matlab-2010a-windows/extern/lib/win32/microsoft/libeng.lib")
			SET(MATLAB_INCLUDE_DIR "Y:/netshare/i386/matlab-2010a-windows/extern/include")
	...
	IF(UNIX)
		IF(APPLE)
			IF(CMAKE_SIZEOF_VOID_P MATCHES "4")
				...
				SET(MATLAB_MEX_LIBRARY "/netshare/x86_mac/matlab-2010a-mac/MATLAB_R2010a.app/bin/maci/libmex.so")
				SET(MATLAB_MX_LIBRARY "/netshare/x86_mac/matlab-2010a-mac/MATLAB_R2010a.app/bin/maci/libmx.so")
				SET(MATLAB_ENG_LIBRARY "/netshare/x86_mac/matlab-2010a-mac/MATLAB_R2010a.app/bin/maci/libeng.so")
			...
			ELSE(CMAKE_SIZEOF_VOID_P MATCHES "4")
				...
				SET(MATLAB_MEX_LIBRARY "/netshare/x86_64_mac/matlab-2010a-mac/MATLAB_R2010a.app/bin/maci64/libmex.so")
				SET(MATLAB_MX_LIBRARY "/netshare/x86_64_mac/matlab-2010a-mac/MATLAB_R2010a.app/bin/maci64/libmx.so")
				SET(MATLAB_ENG_LIBRARY "/netshare/x86_64_mac/matlab-2010a-mac/MATLAB_R2010a.app/bin/maci64/libeng.so")
