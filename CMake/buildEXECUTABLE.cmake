...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mpd_multithread PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mpd PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" ) 
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mpd_demix_multithread PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" ) 
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mpd_demix PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" )
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mpr PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" ) 
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mpf PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" ) 
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mpcat PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" ) 
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mpview PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" ) 
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(mppitch PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" ) 
...
ELSE(MINGW)
SET_TARGET_PROPERTIES(createDefaultDict PROPERTIES COMPILE_FLAGS "${SHARED_FLAGS} -rdynamic")
ENDIF(MINGW)
ENDIF( CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64" ) 
