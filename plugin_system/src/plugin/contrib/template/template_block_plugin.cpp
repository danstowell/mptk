    ...
    const unsigned long int /* filterIdx */ )
{
  ...
  /* Allocate the atom */
  *atom = NULL;
  MP_Atom_c* (*emptyAtomCreator)( void ) = MP_Atom_Factory_c::get_atom_factory()->get_empty_atom_creator("TemplateAtom");
  ...
  if ( (datom =  (MP_Template_Atom_Plugin_c*)(*emptyAtomCreator)())  == NULL )
    {
...
{
  MP_Block_Factory_c::get_block_factory()->register_new_block("template",&MP_Template_Block_Plugin_c::create, &MP_Template_Block_Plugin_c::get_parameters_type_map, &MP_Template_Block_Plugin_c::get_parameters_info_map, &MP_Template_Block_Plugin_c::get_parameters_default_map );
}
